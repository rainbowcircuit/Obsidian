...
var WebRenderer = class extends Events_default {
  constructor() {
    super(...arguments);
    this.context = null;
  }
  initialize(_0) {
    return __async(this, arguments, function* (audioContext, workletOptions = {}, eventInterval = 16) {
      (0, import_invariant.default)(typeof audioContext === "object" && audioContext !== null, "First argument to initialize must be a valid AudioContext instance.");
      (0, import_invariant.default)(typeof workletOptions === "object" && workletOptions !== null, "The optional second argument to initialize must be an object.");
      ...
      if (!workletRegistry.hasOwnProperty(pkgVersion)) {
        const blob = new Blob([elementary_wasm_default, WorkletProcessor_default], { type: "text/javascript" });
      ...
      return yield new Promise((resolve, reject) => {
        this._worklet.port.onmessage = (e) => {
          ...
          if (type === "load") {
            this._renderer = new Renderer((batch) => __async(this, null, function* () {
          ...
          if (type === "reply") {
            ...
            const { resolve: resolve2, reject: reject2 } = this._promiseMap.get(requestId);
  ...
  _sendWorkletRequest(requestType, payload) {
    (0, import_invariant.default)(this._worklet, "Can't send request before worklet is ready. Have you initialized your WebRenderer instance?");
  ...
  render(...args) {
    return __async(this, null, function* () {
      const _a = yield this._renderer.render(...args), { result } = _a, stats = __objRest(_a, ["result"]);
      if (!result.success) {
  ...
  updateVirtualFileSystem(vfs) {
    return __async(this, null, function* () {
      ...
      (0, import_invariant.default)(valid, "Virtual file system must be an object mapping string type keys to Array<Float32Array> | Float32Array type values");
      Object.keys(vfs).forEach(function(key) {
        const validValue = typeof vfs[key] === "object" && (Array.isArray(vfs[key]) || vfs[key] instanceof Float32Array);
        (0, import_invariant.default)(validValue, "Virtual file system must be an object mapping string type keys to Array<Float32Array> | Float32Array type values");
      });
...
//# sourceMappingURL=@elemaudio_web-renderer.js.map
