...
var OutlineNode = class extends TempNode {
  ...
  updateBefore(frame) {
    ...
    _quadMesh2.name = "Outline [ Downsample ]";
    ...
    _quadMesh2.name = "Outline [ Edge Detection ]";
    ...
    _quadMesh2.name = "Outline [ Blur Half Resolution ]";
    ...
    _quadMesh2.name = "Outline [ Blur Quarter Resolution ]";
  ...
  setup() {
    ...
    const separableBlur = Fn2(([kernelRadius]) => {
      ...
      Loop2({ start: int2(1), end: int2(MAX_RADIUS), type: "int", condition: "<=" }, ({ i }) => {
        ...
        const sample22 = this._blurColorTextureUniform.sample(uvNode.sub(uvOffset));
